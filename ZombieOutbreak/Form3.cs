...
namespace ZombieOutbreak
{
    public partial class Form3 : Form
    {
        ...
        {
            //label.BackColor = Color.FromArgb(150, 0, 0, 0);
        ...
        private void MainTimer(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                deathDelayTimer.Tick += (s, args) =>
                {
                    ...
                    Form6 gameOverForm = new Form6(currentLanguage, "Form3");
                    gameOverForm.Show();
                    this.Hide();
                };
        ...
        private void Form3_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            switch (e.KeyCode)
            {
                case Keys.Left: goLeft = true; facing = "left"; player.Image = Properties.Resources.rifle3; player.Height = 180; player.Width = 300; break;
                case Keys.Right: goRight = true; facing = "right"; player.Image = Properties.Resources.rifle1; player.Height = 180; player.Width = 300; break;
                case Keys.Up: goUp = true; facing = "up"; player.Image = Properties.Resources.rifle4; player.Width = 180; player.Height = 300; break;
                case Keys.Down: goDown = true; facing = "down"; player.Image = Properties.Resources.rifle2; player.Width = 180; player.Height = 300; break;
            }
