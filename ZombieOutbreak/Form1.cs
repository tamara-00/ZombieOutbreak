...
namespace ZombieOutbreak
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            button3.Location = new Point(300, 780);
            button3.Size = new Size(480, 60);
            //button3.BackColor = Color.FromArgb(75, 0, 1);
            ...
            instructionsPanel.Size = new Size(600, 500);
            instructionsPanel.Location = new Point(820, 475); 
            instructionsPanel.BackColor = Color.FromArgb(120, 0, 0, 0);
            instructionsPanel.Visible = false; 

            instructionsLabel = new Label();
            instructionsLabel.Size = new Size(580, 480);
            ...
            instructionsLabel.Font = new Font("Century Gothic", 14, FontStyle.Regular);
            instructionsLabel.TextAlign = ContentAlignment.TopLeft;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (currentLanguage == "mk")
            {
                instructions = "Како се игра:\n\n" +
                               "1. Движи се со стрелките \n (← ↑ ↓ →).\n" +
                               "2. Пукај со SPACE.\n" +
                               "3. Собирај предмети за бонуси.\n" +
                               "4. Избегнувај ги зомбињата!\n\n" +
                               "Среќно!";
            }
            else
            {
